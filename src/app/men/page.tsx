                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10 pb-6 border-b border-gray-200">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <select
                                ...
                                className="px-4 py-2 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-slate-500 cursor-pointer appearance-none pr-10"
                                style={{
